...
1. Create a new property ([how?](https://support.google.com/analytics/answer/1042508)) for your CIAB website (You'll need to enter the URL it lives at, so if you want to set up a custom domain, this is best done last)
