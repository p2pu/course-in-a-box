...
skel.init({
	...
	breakpoints: {
		...
		normal:		{ range: '-1280', href: '{{ site.baseurl }}/css/style-normal.css', containers: 960, lockViewport: true },
		...
		mobile:		{ range: '-640', href: '{{ site.baseurl }}/css/style-mobile.css', containers: '100%', grid: { gutters: 15, collapse: 2 } }
	}
}, {
	layers: {
